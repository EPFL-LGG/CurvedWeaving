...
struct TargetSurfaceFitter {
    ...
    void constructTargetSurface(const RodLinkage &linkage, size_t loop_subdivisions = 0,  Eigen::Vector3d scale_factors = Eigen::Vector3d(1, 1, 1));
    ...
    const Eigen::MatrixXd getTargetSurfaceVertices() const { return m_tgt_surf_V; }
    const Eigen::MatrixXi getTargetSurfaceFaces()   const { return m_tgt_surf_F; }
    const Eigen::MatrixXd getTargetSurfaceNormals() const { return m_tgt_surf_N; }
