...
def get_optimization_diagram_worker(model_info):
    ...
    if os.path.exists('{}/manual_{}.png'.format(data_root, name)):
        convert_png_to_jpg('{}/manual_{}.png'.format(data_root, name))
        return
    ...
    renderToFile(curved_linkage_view, renderCam, '{}/manual_{}.png'.format(data_root, name))
